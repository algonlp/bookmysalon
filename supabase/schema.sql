...
alter table customer_account_records enable row level security;
alter table email_log_records enable row level security;
alter table sms_log_records enable row level security;
