...
const recipientToRow = (recipient: CampaignRecipientRecord): Row => ({
  ...
  whatsapp_status: recipient.whatsappStatus,
  whatsapp_reason: recipient.whatsappReason,
  whatsapp_message_id: recipient.whatsappMessageId,
...
const rowToRecipient = (row: Row): CampaignRecipientRecord => ({
  ...
  whatsappStatus: (asText(row.whatsapp_status) || 'not_applicable') as CampaignDispatchStatus,
  whatsappReason: asText(row.whatsapp_reason),
  whatsappMessageId: asText(row.whatsapp_message_id),
