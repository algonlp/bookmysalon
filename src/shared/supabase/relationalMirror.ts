    ...
    [
      {
        ...
        service_amount_value: asNumber(paymentRecord.serviceAmountValue ?? paymentRecord.amountValue),
        tip_amount_value: asNumber(paymentRecord.tipAmountValue ?? 0),
        tip_recipient_name: asText(paymentRecord.tipRecipientName),
